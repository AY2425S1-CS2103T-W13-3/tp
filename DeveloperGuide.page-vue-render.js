...
with(this){return _c('h2',{attrs:{"id":"this-project-is-based-on-the-addressbook-level3-project-created-by-the-se-edu-initiative"}},[_v("This project is based on the AddressBook-Level3 project created by the "),_c('a',{attrs:{"href":"https://se-education.org"}},[_v("SE-EDU initiative")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#this-project-is-based-on-the-addressbook-level3-project-created-by-the-se-edu-initiative","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-W13-3/tp/blob/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-W13-3/tp/blob/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-W13-3/tp/blob/master/src/main/java/seedu/address/model/Model.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-W13-3/tp/blob/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant number of patients")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")]),_v(" "),_c('li',[_v("most likely a psychiatrist/psychologist")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": manage patients faster than a typical mouse/GUI driven app")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add a patient contact")]),_v(" "),_c('td',[_v("track the details of a specific patient under my care")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete a patient contact")]),_v(" "),_c('td',[_v("get rid of patient details that are no longer under my care")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add a session log")]),_v(" "),_c('td',[_v("record the session details with a specific patient")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete session log")]),_v(" "),_c('td',[_v("remove unwanted session log")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("store data locally")]),_v(" "),_c('td',[_v("keep patient data private")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("get a manual all the available commands (-help command)")]),_v(" "),_c('td',[_v("learn all the possible commands to fully utilize the app")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("clear the list of patients")]),_v(" "),_c('td',[_v("start from an empty patient list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("edit session log/ patient information")]),_v(" "),_c('td',[_v("change incorrect or out of date information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("confirm a command")]),_v(" "),_c('td',[_v("verify if I really want to do an action")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("cancel a command")]),_v(" "),_c('td',[_v("reverse an action that I did not intend to do")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("be able to classify my patient as discharged/new")]),_v(" "),_c('td',[_v("cross reference their progress")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("group session based on patient")]),_v(" "),_c('td',[_v("see each session with a specific patient")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete logs related to a patient")]),_v(" "),_c('td',[_v("remove specific patient session log efficiently")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("log time, date of sessions")]),_v(" "),_c('td',[_v("to keep track of progress and frequency of patient")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("search/filter for specific patient using keyword")]),_v(" "),_c('td',[_v("quickly find relevant details of patient")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MindMap")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: U01 Add Patient Detail")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The input fields are invalid")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System display an error message.")])]),_v(" "),_c('li',[_c('p',[_v("2a2. System request for correct data.")])]),_v(" "),_c('li',[_c('p',[_v("2a3. User enters new data.")]),_v(" "),_c('p',[_v("Steps 2a1-2a3 are repeated until the data entered are correct.\nUse case resumes from step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. Patient does not exist in contact details")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. System display an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("4a. User does not confirm addition")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("4a1. System display a message indicating that the addition was canceled.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User inputs the command to delete a patient's contact details.")]),_v(" "),_c('li',[_v("System validates the input fields.")]),_v(" "),_c('li',[_v("System check to confirm patient exists")]),_v(" "),_c('li',[_v("System confirms the deletion with the user.")]),_v(" "),_c('li',[_v("System deletes the patient's contact details from the contact list.")]),_v(" "),_c('li',[_v("System displays a success message.")]),_v(" "),_c('li',[_v("System updates the contact list to exclude the deleted patient.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User inputs the command to add a session log to the patient detail.")]),_v(" "),_c('li',[_v("System validates the input fields.")]),_v(" "),_c('li',[_v("System check to confirm patient exist.")]),_v(" "),_c('li',[_v("System adds the session log to the patient detail.")]),_v(" "),_c('li',[_v("System displays a success message.")]),_v(" "),_c('li',[_v("System updates the patient detail to reflect the new entry.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("CLI")]),_v(": Command Line Interface, allows users to interact with the application by typing commands instead of using a graphical interface.")]),_v(" "),_c('li',[_c('strong',[_v("Macro")]),_v(": A feature that automates repetitive tasks by allowing users to combine multiple commands into one.")]),_v(" "),_c('li',[_c('strong',[_v("Logging")]),_v(": The process of documenting patient session details, actions taken, and other relevant data.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 11 Nov 2024, 12:02:21 GMT+8]")])])])}
}];
